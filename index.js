...
function readHtmlValues() {
  ...
  // }
  //   boxNumber = Math.floor(Math.random() * 10) + 1;
  levelSize = 8 + boxNumber;
}

//display slider values
function displayHtmlValues() {
  document.getElementById("sizeTxt").innerHTML =
    "level size: " + String(document.getElementById("sizeSlider").value);
  document.getElementById("boxTxt").innerHTML =
    "number of boxes: " + String(document.getElementById("numSlider").value);
}
